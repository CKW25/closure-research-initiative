...
repaired intrinsic--smooth interface are mathematically constrained,
...
\begin{definition}[Comparison world]
	...
	therefore the primitive-level expression of the intrinsicity clause
...
enters the repaired intrinsic--smooth interface: the degree--\(2\)
...
realized curvature.  The subsequent macroscopic, scalar, and
...
\[
		\begin{aligned}
			...
			\\
			\;&\Longrightarrow\;\text{repaired intrinsic--smooth interface and macroscopic compatibility laws}
			\\
...
\begin{theorem}[Structural rigidity of closed relational systems]
	...
	\begin{enumerate}[label=\textup{(\arabic*)}]
		...
		\item
		      ...
		      curvature on the realized degree--\(2\) channel.  This
...
\begin{proof}
	...
	\cref{ch:triangles,ch:descent_obstruction,ch:bridge}.
		...
		repaired intrinsic-to-smooth interface, and their macroscopic
		continuations in
...
field-theoretic, scalar, and realization-level structure, and only
afterward any appendix-level application.
...
symmetry-invariant of comparison---which is the intrinsicity clause
...
\cref{ch:foundation,ch:closure,ch:locus,ch:bridge,ch:interface,ch:einstein,ch:em,ch:matter,ch:numerical-closure}.
This path isolates the main boundary and rigidity statements with minimal
technical detours.

A second reading is construction-driven:
\cref{ch:bottom,ch:lift,ch:descent_obstruction,ch:flow,ch:stitching,ch:christoffel,ch:connection,ch:matter-numbers,ch:matter-realization,app:fusion}.
...
geometric, field-theoretic, scalar, and realization-level closure.
