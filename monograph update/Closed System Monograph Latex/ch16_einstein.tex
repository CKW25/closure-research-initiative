...
compatibility consequences of the repaired intrinsic transport package
...
\begin{proof}
	...
	forward only through the repaired interface statement: under the
...
\begin{proof}[Proof of \cref{thm:einstein-main}]
	...
	\[
		\mathcal K_\infty\subset F^2/F^3
	\]
	whose realized degree--\(2\) channel, under the inherited second-jet faithfulness condition, carries the same repaired curvature bridge:
