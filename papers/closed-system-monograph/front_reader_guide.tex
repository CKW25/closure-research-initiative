...
% ============================================================
This monograph is organized as a dependency chain.  It need not be
read linearly on a first pass, but the order of
...
For the primitive status of the theory, the shortest route is
\begin{center}
...
For holonomy, curvature, and smooth realization, the shortest route is
\begin{center}
...
For the downstream physical sectors, the shortest route is
\begin{center}
...
recurring notation and conventions used throughout the monograph.
