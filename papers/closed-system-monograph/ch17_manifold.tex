...
reconstruction.
The statement is local in the sense required by differential geometry.
It identifies the realized regular locus as a smooth four-dimensional
Lorentzian arena carrying the connection and curvature read from the
transport tower.  It is not a global topology theorem and does not
replace the quotient-level construction of the preceding chapters.
