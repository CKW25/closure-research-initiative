...
problems.  This distinction is part of the formal content of the monograph:
...
Hilbert space, or causal order.  The comparison-world definition is fixed
in the Introduction; the finite-to-global boundary is developed in
\cref{ch:foundation}.
