...
This is a realized-branch compatibility theorem.  It does not take
general relativity as a primitive framework, and it does not assert that
all downstream source terms have already been reconstructed.  It
classifies the second-order metric compatibility law admissible once the
preceding transport, scalar, Hilbert, and second-jet interface results
have supplied the realized metric branch.
...
\[
	F^2/F^3.
\]
This identification is made under the inherited second-jet faithfulness
condition.
% ============================================================
