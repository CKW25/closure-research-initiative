...
\orientationitem{Input}{The closed-world compactness clause and a finite-stage Boolean refinement/exclusion tower.}
\orientationitem{Role}{This chapter isolates the exact boundary between finite admissibility and global admissibility.}
\orientationitem{Output}{The inverse-limit and ultrafilter form of the quantifier-reversal obstruction, used later in the comparison-completeness argument.}
...
the compactness clause of closed-world admissibility.
...
\closingitem{Established}{Finite-stage admissibility globalizes exactly when the exclusion tower has no finite covering failure.}
\closingitem{Carried forward}{This compactness boundary supplies the Boolean mechanism used to derive comparison completeness.}
\end{chapterclosing}
