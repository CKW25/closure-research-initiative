...
\orientationitem{Input}{The stabilized quadratic carrier, its scalar form, and orientation reversal on the transport defect sector.}
\orientationitem{Role}{This chapter reconstructs complex Hilbert structure from the quadratic transport layer.}
\orientationitem{Output}{The oriented defect double, complex structure, Hermitian form, and Born-rule scalar needed by the Einstein and phase-curvature chapters.}
...
\end{remark}
The point is that positivity is strict, not merely weak.
...
\closingitem{Established}{Complex Hilbert structure, the Hermitian scalar, norm-square probability, and phase sector are reconstructed from the stabilized quadratic transport carrier.}
\closingitem{Carried forward}{The same carrier is read on the realized geometric branch to obtain the macroscopic compatibility law.}
\end{chapterclosing}
