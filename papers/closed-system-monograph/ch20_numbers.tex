...
data.
Consequently, the chapter fixes dimensionless internal ratio structure
only to the extent supplied by the closure chain and the declared
calibration data.  Absolute physical units and external identifications
are not inferred from the quartic carrier alone.
