...
\orientationitem{Input}{The triangle obstruction of \cref{ch:triangles} and the loop-representation obstruction of \cref{ch:descent_obstruction}.}
\orientationitem{Role}{This chapter proves that the finite and loop descriptions are the same transport datum in different forms.}
\orientationitem{Output}{The rigidity bridge connecting discrete obstruction theory to the later observer, spacetime, and curvature constructions.}
...
The theorem is the handoff from finite diagonal obstruction to transport
obstruction.  It does not add smoothness, curvature, or a graded
filtration.  It identifies the same finite triangle failure as a failure
of descent for transport on the corresponding directed loop.  Later
chapters refine this loop residue as graded transport data.
...
\closingitem{Established}{Finite triangular incompatibility, nontrivial loop defect, and failure of transport descent are one obstruction class on the minimal triangle subsystem.}
\closingitem{Carried forward}{The identified obstruction enters the observer-level and stitched-spacetime constructions without adding smooth structure yet.}
\end{chapterclosing}
