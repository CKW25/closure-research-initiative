...
\orientationitem{Input}{Representative lifts, diagonal \(n\)-point semantics, and stabilizer-coset alignment data.}
\orientationitem{Role}{This chapter identifies the first finite arity at which transport obstruction can be detected.}
\orientationitem{Output}{The triangle regime and its transport realization, which supply the finite witness later matched with loop obstruction.}
...
% ============================================================
The triangle regime is the first possible location of a genuinely
multi-point obstruction.  Pairwise alignment data can all be present and
still fail to determine a single compatible diagonal gauge for three
points.  The next theorem identifies this regime as the first finite
witness of morphism-level content not seen by two-point quotient data.
...
\closingitem{Established}{The triangle regime is the first irreducible finite configuration in which pairwise compatibility fails to globalize.}
\closingitem{Carried forward}{The finite witness is globalized next as loop-representation descent obstruction.}
\end{chapterclosing}
