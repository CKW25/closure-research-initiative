...
\orientationitem{Input}{The action groupoid of the quotient system and the two-locus enrichment classification.}
\orientationitem{Role}{This chapter turns the classification into a lift calculus, including existence, gauge change, and holonomy.}
\orientationitem{Output}{A precise language for representative choices and transport cocycles, used by the triangle and loop-obstruction chapters.}
...
This strengthening is used throughout the later transport and smooth
...
\closingitem{Established}{A representative lift is object choice together with compatible flat \(G\)-transport; nontrivial loop holonomy is the obstruction to reducing it to object choice alone.}
\closingitem{Carried forward}{The first finite witness of this morphism defect is isolated by comparison triangles.}
\end{chapterclosing}
