...
\orientationitem{Input}{The observer-side filtration from \cref{ch:flow} and the closed transport/refinement structure of the quotient stack.}
\orientationitem{Role}{This chapter interleaves refinement and observer reduction inside the closed system.}
\orientationitem{Output}{The intrinsic spacetime arena \(ST\), later used for curvature realization, causal scaling, and connection-first geometry.}
...
\]
for the corresponding Stone spaces \cite{Stone1936}.  Restriction of ultrafilters along
the inclusions
\[
	\B_k\subseteq\B_{k+1}
\]
...
\closingitem{Established}{The stitched object \(ST\) represents refinement and observer-induced temporal coarsening within one closed construction.}
\closingitem{Carried forward}{The stitched arena is the comparison-side setting for realizing transport obstruction as curvature.}
\end{chapterclosing}
