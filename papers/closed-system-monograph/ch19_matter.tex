...
\orientationitem{Input}{The phase-curvature sector, the realized internal gauge labels, and the canonical quadratic scalar channel.}
\orientationitem{Role}{This chapter defines the intrinsic scalar invariant and refinement-depth data for primitive matter sectors.}
\orientationitem{Output}{Sector classification by gauge representation data, scalar defect class, and refinement depth, including the separation of sectors with identical gauge labels.}
...
the scalar-channel identification on admissible classes, not
...
\closingitem{Established}{Primitive sectors are organized by gauge labels, orientation parity, refinement depth, and the canonical positive scalar invariant \(m_0(\sigma)=Q(\kappa_\sigma)\).}
\closingitem{Carried forward}{Refinement depth and the scalar invariant provide the input for conditional numerical closure.}
\end{chapterclosing}
