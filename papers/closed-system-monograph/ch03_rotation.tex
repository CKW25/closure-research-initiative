...
The equality asserted here is quotient equality.  The representatives
need not coincide in \(X\), and the labels attached to their comparison
edges need not be equal as representative data.  What is invariant is
their image in \(\Phys=X/G\), hence every coherent report reads the same
content from either representative.
