...
\cite{Isham1993,Kuchar1992,Anderson2017}, but the present manuscript uses
...
The book therefore uses three recurring statuses.
...
The foundational admissibility content of this manuscript is concentrated
...
Intrinsicality is not a hypothesis about the universe
...
observer-side, and quantitative clauses are therefore not hidden
foundational primitives; they are scoped realization data, derived
interface results, or explicitly recorded boundary conditions.
...
Thus the chapter order is not only expository.  It records the order in
which structures become admissible.

\section{Conclusion}
\label{sec:introduction-conclusion}
This introduction fixes the mathematical entry point of the manuscript:
primitive comparison data, closed-world admissibility, and the structural
theorem whose proof is distributed across the book.  The chapter
