...
\begin{remark}
	...
	criterion states that this necessary condition is also
	sufficient.
\end{remark}
% ============================================================
...
% ============================================================
The remaining alternatives now separate into two structural loci.  A
section records which representative of an already fixed orbit is
displayed.  Holonomy records the transport assigned between
representatives along a protocol.  The later obstruction theory uses this
division unchanged: object-locus choices are gauge choices, while
morphism-locus data carry route dependence.
