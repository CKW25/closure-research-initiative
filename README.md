...
Chast K. Wolfe, *Closed Systems from Comparison Completeness*, v10, Closure Research Initiative, 2026. Current version: [closureresearchinitiative.org/csm/](https://closureresearchinitiative.org/csm/). DOI pending for v10; prior DOI records are retained with their archived versions.
...
|------|-------|--------|-----------------|
| `csm` | *Closed Systems from Comparison Completeness* | Monograph, v10 | [Current page](https://closureresearchinitiative.org/csm/) |
