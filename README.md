...
Chast K. Wolfe, *Closed Systems from Comparison Completeness*, v9, Closure Research Initiative, 2026. Current version: [closureresearchinitiative.org/csm/](https://closureresearchinitiative.org/csm/). DOI pending for v9; prior DOI records are retained with their archived versions.
...
|------|-------|--------|-----------------|
| `csm` | *Closed Systems from Comparison Completeness* | Monograph, v9 | [Current page](https://closureresearchinitiative.org/csm/) |
